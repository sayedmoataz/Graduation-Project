...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.glartek.flutter_unity.FlutterUnityPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_unity, com.glartek.flutter_unity.FlutterUnityPlugin", e);
    }
    try {
